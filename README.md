...
- **Frontend Development** — Building responsive, performant user interfaces with modern frameworks
- **Backend Development** — Designing APIs, microservices, and data pipelines
- **Observability & Monitoring** — Implementing comprehensive monitoring with tools like NewRelic, crafting NRQL queries, and tracking down production issues
- **Technical Leadership** — Mentoring developers, driving architectural decisions, and collaborating with stakeholders
...
![REST APIs](https://img.shields.io/badge/REST-009688?style=flat-square&logo=fastapi&logoColor=white)
...
![NewRelic](https://img.shields.io/badge/New_Relic-008C99?style=flat-square&logo=newrelic&logoColor=white)
...
<details>
<summary><b>Infrastructure (Home Lab & Beyond)</b></summary>
...
<details>
<summary><b>Security & Hardware (Side Projects)</b></summary>
...
- 🏠 **Infrastructure** — Proxmox clusters, TrueNAS with ZFS pools, self-hosted everything
- 📹 **Video Surveillance** — Frigate NVR with AI object detection and hardware acceleration
- 🔐 **Security Research** — Reverse engineering firmware, wireless pentesting, hardware hacking
- 📡 **Radio & Networking** — SDR experiments with HackRF One, WiFi security analysis
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/gabrielradzki)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:gabriel@radzkitech.com)
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=gabrielradzki&color=blueviolet&style=flat-square" alt="Profile Views" />
</p>
